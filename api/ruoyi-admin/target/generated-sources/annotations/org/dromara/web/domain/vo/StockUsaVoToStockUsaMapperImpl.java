...
@Component
public class StockUsaVoToStockUsaMapperImpl implements StockUsaVoToStockUsaMapper {

    @Override
    public StockUsa convert(StockUsaVo arg0) {
        if ( arg0 == null ) {
            return null;
        }
    ...
    @Override
    public StockUsa convert(StockUsaVo arg0, StockUsa arg1) {
        if ( arg0 == null ) {
            return arg1;
        }
