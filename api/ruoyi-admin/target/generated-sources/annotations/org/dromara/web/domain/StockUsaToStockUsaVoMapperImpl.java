...
@Component
public class StockUsaToStockUsaVoMapperImpl implements StockUsaToStockUsaVoMapper {

    @Override
    public StockUsaVo convert(StockUsa arg0) {
        if ( arg0 == null ) {
            return null;
        }
    ...
    @Override
    public StockUsaVo convert(StockUsa arg0, StockUsaVo arg1) {
        if ( arg0 == null ) {
            return arg1;
        }
