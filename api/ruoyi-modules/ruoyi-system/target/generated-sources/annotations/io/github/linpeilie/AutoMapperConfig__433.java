...
@MapperConfig(
    ...
    uses = {ConverterMapperAdapter__433.class, SysSocialVoToSysSocialMapper.class, SysDictDataVoToSysDictDataMapper.class, SysOssConfigToSysOssConfigVoMapper.class, SysLogininforVoToSysLogininforMapper.class, SysConfigBoToSysConfigMapper.class, SysTenantPackageToSysTenantPackageVoMapper.class, SysPostBoToSysPostMapper.class, SysOssConfigVoToSysOssConfigMapper.class, SysUserToSysUserVoMapper.class, SysDictTypeVoToSysDictTypeMapper.class, SysDictDataToSysDictDataVoMapper.class, SysMenuBoToSysMenuMapper.class, SysRoleVoToSysRoleMapper.class, SysConfigToSysConfigVoMapper.class, SysOperLogBoToOperLogEventMapper.class, SysClientVoToSysClientMapper.class, SysOssConfigBoToSysOssConfigMapper.class, SysNoticeVoToSysNoticeMapper.class, SysDeptBoToSysDeptMapper.class, SysOssBoToSysOssMapper.class, SysMenuVoToSysMenuMapper.class, SysMenuToSysMenuVoMapper.class, SysTenantVoToSysTenantMapper.class, SysUserBoToSysUserMapper.class, SysClientBoToSysClientMapper.class, SysDictDataBoToSysDictDataMapper.class, SysUserVoToSysUserMapper.class, SysClientToSysClientVoMapper.class, SysNoticeToSysNoticeVoMapper.class, SysOssToSysOssVoMapper.class, SysOperLogToSysOperLogVoMapper.class, SysLogininforBoToSysLogininforMapper.class, SysDeptVoToSysDeptMapper.class, SysTenantToSysTenantVoMapper.class, SysConfigVoToSysConfigMapper.class, SysSocialBoToSysSocialMapper.class, SysRoleBoToSysRoleMapper.class, SysOssVoToSysOssMapper.class, SysDictTypeToSysDictTypeVoMapper.class, SysRoleToSysRoleVoMapper.class, SysTenantPackageVoToSysTenantPackageMapper.class, SysTenantBoToSysTenantMapper.class, SysTenantPackageBoToSysTenantPackageMapper.class, SysLogininforToSysLogininforVoMapper.class, SysPostVoToSysPostMapper.class, SysSocialToSysSocialVoMapper.class, SysDictTypeBoToSysDictTypeMapper.class, OperLogEventToSysOperLogBoMapper.class, SysOperLogBoToSysOperLogMapper.class, SysOperLogVoToSysOperLogMapper.class, SysDeptToSysDeptVoMapper.class, SysNoticeBoToSysNoticeMapper.class, SysPostToSysPostVoMapper.class},
    unmappedTargetPolicy = ReportingPolicy.IGNORE,
    builder = @Builder(buildMethod = "build", disableBuilder = true)
)
public interface AutoMapperConfig__433 {
}
