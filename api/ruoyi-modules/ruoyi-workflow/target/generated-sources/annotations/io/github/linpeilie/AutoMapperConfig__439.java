...
@MapperConfig(
    ...
    uses = {ConverterMapperAdapter__439.class, FlowCategoryVoToFlowCategoryMapper.class, FlowCategoryBoToFlowCategoryMapper.class, TestLeaveBoToTestLeaveMapper.class, TestLeaveVoToTestLeaveMapper.class, TestLeaveToTestLeaveVoMapper.class, FlowCategoryToFlowCategoryVoMapper.class},
    unmappedTargetPolicy = ReportingPolicy.IGNORE,
    builder = @Builder(buildMethod = "build", disableBuilder = true)
)
public interface AutoMapperConfig__439 {
}
